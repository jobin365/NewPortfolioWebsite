...
function App() {
  ...
  return (
    <div className="App">
      <h1 className='headingRed'><i className="fas fa-user"></i> About</h1>
      ...
      <h1 className='headingRed'><i className="fas fa-bolt"></i> Skills</h1><br/>
      ...
      <h1 className='headingRed'><i className="fas fa-suitcase"></i> Experience</h1><br/>
      <h2>Intern</h2>
